...
class GUI():
    def __init__(self,master):
        ...
        self.label = Label(text="PASSWORD GENERATOR", anchor=N, fg='#030303', bg='#f9f4f4', font='arial 20 bold underline')
        ...
        self.user = Label(text=" User Name ", font='arial 14 bold', bg='#f9f4f4', fg='#030303')
        ...
        self.length = Label(text="Enter Password Length: ", font='ariel 14 bold', bg='#f9f4f4', fg='#030303')
        ...
        self.generated_password = Label(text="Generated Password: ", font='ariel 14 bold', bg='#f9f4f4', fg='#030303')
        ...
        self.generate = Button(text="Generate password", bd=3, relief='solid', padx=1, pady=1, font='ariel", 14 bold', fg='#030303', bg='#f9f4f4', command=self.generate_pass)
    ...
    def generate_pass(self):
        ...
        if name.isalpha()==False:
            messagebox.showerror("Error","user name should be a string")
    ...
    def accept_fields(self):
        with sqlite3.connect("users.db") as db:
            ...
            if cursor.fetchall():
            	messagebox.showerror("This username is taken!", "try another")
            else:
